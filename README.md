...
| [Bromite Extended (Soft) Russian](https://github.com/ivan-volnov/filtrite/releases/latest/download/bromite-extended-soft-ru.dat)             | The "Russian-NoCoins-NoCookies" list with additional region-specific blocklists for russian sites                            |
